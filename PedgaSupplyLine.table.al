table 60502 "Pedga Operational Header"
{
    ...
    fields
    {
        ...
        field(6; "Lot No."; Code[50])
        {
            trigger OnValidate()
            var
                ThiocureLine: Record "Thiocure Operational Header";
            begin
                // Match same Work Order + Line No.
                if ThiocureLine.Get("Work Order No.", "Line No.") then begin
                    ThiocureLine.Validate("Lot No.", Rec."Lot No.");
        ...
        field(10; "Performed By"; Text[100]) { }
        field(11; Date; Date) { }
    }
    ...
    trigger OnInsert()
    var
        LastLine: Record "Pedga Operational Header";
    ...
    var
        LineRec: Record "Pedga Operational Header";
        Counter: Integer;
    begin
        Counter := 1;
